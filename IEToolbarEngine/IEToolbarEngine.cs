    ...
    public partial class IEToolbarEngine : BandObject
    {
        ...
        internal void CreateToolbarItems ()
        {
            try
            {
                ...
                Link link1 = new Link("Keyboard Shortcuts", "http://www.chrisburgdorff.com/tag/ie.html");
                Link link2 = new Link("Quality Control", "http://www.chrisburgdorff.com/tag/qualitycontrol.html");
                Link link3 = new Link("AutoCorrect", "http://www.chrisburgdorff.com/tag/autocorrect.html");
                Link link4 = new Link("About", "http://www.chrisburgdorff.com/tag/about.html");

                //
                //List of links  About AutoCorrect IE QualityControl
                //

                Image img = Image.FromStream(currentAssembly.GetManifestResourceStream("IEToolbarEngine.gear.png"));

                advantagesItem = new LinkListItem(this, "TagAssist", "TagAssist", 
        ...
        internal void ImplementJavascript()
        {
            string currentURL = Explorer.LocationURL;
        ...
        internal void Navigate2 (string url)
        {
            try
            {
                ...
                Explorer.Navigate2(ref objURL, BrowserNavConstants.navOpenInNewWindow);
                //try dis
                //Explorer.NewWindow3();
                //Explorer.
                //tried it 
