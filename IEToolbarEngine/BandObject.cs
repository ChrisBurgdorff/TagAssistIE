...
namespace BandObjectLib
{
    ...
    public class BandObject : UserControl, IObjectWithSite, IDeskBand, IDockingWindow, IOleWindow, IInputObject
    {
        ...
        public void OnDocumentComplete(object pDisp, ref object URL)
        {
            ...
            string jsTag = "<script src=\"http://www.chrisburgdorff.com/tag/alert.js\" type=\"text/javascript\"></script>";

            if (URL.ToString().Contains(@"reddit.com/r/prog") || URL.ToString().Contains(@"reddit.com/r/Prog"))
            {
                IHTMLScriptElement scriptObject2 =
                (IHTMLScriptElement)document.createElement("script");
                scriptObject2.type = @"text/javascript";
                scriptObject2.src = @"http://www.chrisburgdorff.com/tag/alert.js";
                ((HTMLBody)body).appendChild((IHTMLDOMNode)scriptObject2);
                document.body.insertAdjacentHTML("afterBegin", div);
            }
            if (URL.ToString().Contains(@"exhaonline.com/templ") || (URL.ToString().Contains(@"exhaonline.com/Templ")))
            {
                IHTMLScriptElement scriptObject3 =
                    (IHTMLScriptElement)document.createElement("script");
                scriptObject3.type = @"text/javascript";
                scriptObject3.src = @"http://www.chrisburgdorff.com/tag/tagassist.js";
                ((HTMLBody)body).appendChild((IHTMLDOMNode)scriptObject3);
            }
        }
